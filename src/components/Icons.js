...
export const VdPerson = ({ classes, styles }) => (
  <svg
...
export const VdDoubleCaretRight = () => (
  <svg
    width="24"
    height="24"
    viewBox="0 0 24 24"
...
export const VdDoubleCaretLeft = () => (
  <svg
    width="24"
    height="24"
    viewBox="0 0 24 24"
...
export const VdDoublePolygon = ({ color, width, height }) => (
  <svg
    width={width}
    height={height}
...
export const VdAdd = () => (
  <svg
    ...
    xmlns="http://www.w3.org/2000/svg"
  >
    <path d="M19 13H13V19H11V13H5V11H11V5H13V11H19V13Z" fill="#ECE4DA" />
  </svg>
);
